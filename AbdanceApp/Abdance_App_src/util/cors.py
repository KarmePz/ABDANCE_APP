...
ALLOWED_ORIGINS = [
    "https://abdance-app-frontend-83p6ivyci-camilos-projects-fd28538a.vercel.app"
]
...
def apply_cors(response_tuple):
    data, status = response_tuple
    response = make_response(jsonify(data), status)
    response.headers['Access-Control-Allow-Origin'] = 'https://abdance-app-frontend-83p6ivyci-camilos-projects-fd28538a.vercel.app'
    return response
